/**
 * MyWebServiceServiceCallbackHandler.java
 *
...
/**
 * MyWebServiceServiceCallbackHandler Callback class, Users can extend this class and implement
 * their own receiveResult and receiveError methods.
 */
public abstract class MyWebServiceServiceCallbackHandler {
   ...
   */
  public MyWebServiceServiceCallbackHandler(Object clientData) {
    this.clientData = clientData;
  }

  /** Please use this constructor if you don't want to set any clientData */
  public MyWebServiceServiceCallbackHandler() {
  ...
  /**
   * auto generated Axis2 call back method for getInfo method override this method for handling
   * normal response from getInfo operation
   */
